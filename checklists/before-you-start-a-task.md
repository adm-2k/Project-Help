...
Two minutes of checking now saves hours of untangling later. When you pull the latest shared work and claim your task, you build on top of everyone's newest changes and nobody else starts the same thing. This small habit is what keeps a four-person team from tripping over each other.

> Tip: Your AI builder (Claude Code, Cursor, and the like) can do every git step below for you; ask in plain English. The buttons in GitHub Desktop work too.
...
- [ ] You created your branch from the latest `main` (a _branch_ is your own safe copy to work on, see the [glossary](../GLOSSARY.md))
...
> Watch out: Don't create your branch from an old copy of `main`. Always pull first, then branch. Otherwise you'll be building on yesterday's version and risk a needless conflict later.
