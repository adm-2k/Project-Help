...
> 💡 **Tip:** Your AI builder or GitHub Desktop will do the actual merge with one button. Your job is the thinking around it — these checks.
...
- [ ] The **description is accurate** — it matches what the branch actually changes
...
> ⚠️ **Watch out:** Don't forget to tell everyone to pull after a merge. If teammates keep working on an old `main`, they'll hit avoidable conflicts later. One quick message in your channel prevents it.
