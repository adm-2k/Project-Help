...
Think of each prompt as a small, reusable "skill" your whole team shares. Instead of inventing what to say to the AI every time, you grab the right prompt, fill in the blanks, and go. Everyone gets consistent results.
...
> 💡 **New to these terms?** A *prompt* is just the message you send to your AI. Your *AI builder* is the tool you're working in (Claude Code, Cursor, etc.). If anything else is unfamiliar, check the [glossary](../GLOSSARY.md).

## ⚡ Optional: save prompts as reusable skills in your tool

Once a prompt works well for your team, you can save it inside your tool so it's one click away next time. This is optional — copy-paste is perfectly fine.
...
These six habits make the difference between a confused AI and a helpful one.
...
| **Ask it to explain** | Tell the AI to explain what it's doing and why, in plain English. If you don't understand the explanation, ask again. |
...
| **Say what NOT to touch** | Tell the AI which files or features to leave alone. This keeps it from breaking a teammate's work. |

> ⚠️ **Watch out:** Never paste in passwords, private keys, or other secrets. Treat anything you send like it could be read by someone else.
...
> 💬 **Tip:** Don't treat a prompt's output as final. It's a strong first draft. Your judgment — and your team's — is always the last word.
