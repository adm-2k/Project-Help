...
```
You are an experienced product manager. Help me turn rough notes into a clear, focused PRD.

Here are my rough notes about the app:
[PASTE YOUR ROUGH NOTES HERE — app idea, who it's for, what it should do]

Please write a PRD using EXACTLY these sections, in this order:
1. Overview (one-line pitch + a short paragraph)
2. Who it's for (the users and what they need)
3. Goals and success criteria (how we'll know it works)
4. v1 scope (the smallest useful version — keep this SMALL)
5. Out of scope for v1 (things we'll do later)
6. Open questions (anything unclear or undecided)

Rules:
- Keep v1 as small as possible. If something can wait, put it in "Out of scope".
- For anything you're unsure about or that I haven't specified, do NOT guess —
  add it to "Open questions" instead.
- Write in plain English for a non-technical team.
- Keep the whole document to about 1 to 2 pages.
