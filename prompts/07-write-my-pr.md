# ✍️ Prompt: Write my pull request
...
> 💡 **Tip:** You do not have to write a word yourself. Let the AI draft it, then read it like a teammate would and fix anything that does not match what you actually did.

## 💬 The prompt

Copy this into your AI builder (Claude Code, Cursor, etc.). Fill in the parts in [BRACKETS].
...
> 🎯 **Why this matters:** A good PR description means your reviewer understands your work in under a minute. That gets your feature merged faster and with less back-and-forth.
...
2. Check the "Related task/issue" line points at the right task.
3. Try the "How to test it" steps yourself. If you cannot follow them, your reviewer cannot either — ask the AI to simplify.
4. If screenshots are needed, capture them and drag them into the PR on GitHub.
5. Paste the final text into the PR description box and open the PR.

## ⚠️ Watch out

> - **Empty or vague descriptions** like "fixed stuff" force your reviewer to guess. Always say what changed and how to test it.
> - The AI can only see what is **committed and pushed**. If something is missing from the summary, you may have unsaved work — go back and save it.
> - Do not let the AI claim work you did not do. If it lists a change you do not recognize, ask it to recheck the diff.
